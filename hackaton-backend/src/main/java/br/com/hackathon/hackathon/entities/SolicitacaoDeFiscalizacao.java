...
public class SolicitacaoDeFiscalizacao {
    ...
    public SolicitacaoDeFiscalizacao(Long numeroSolicitacao, LocalDate dataSolicitacao, String tipoSolicitacao, String situacaoAtual, String processosVinculados) {
